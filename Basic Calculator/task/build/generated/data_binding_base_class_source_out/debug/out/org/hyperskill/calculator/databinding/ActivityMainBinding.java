...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button addButton,
      ...
      @NonNull Button button9, @NonNull Button clearButton, @NonNull Button divideButton,
      @NonNull Button dotButton, @NonNull EditText editText, @NonNull Button equalButton,
      @NonNull Guideline guideline, @NonNull Button multiplyButton,
      @NonNull Button subtractButton) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, addButton, button0, button1,
          ...
          divideButton, dotButton, editText, equalButton, guideline, multiplyButton,
          subtractButton);
    }
